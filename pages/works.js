        ...
        <SimpleGrid column={[1, 1, 2]} gap={6}>
          <Section delay={0.3}>
            <WorkGridItem id="sanctum" title="Sanctum" thumbnail={thumbSanctum}>
              ...
              development)! Create and control your own character with 3D
              models, and embark on epic adventures with up to 4 friends. Stay
              tuned for updates as we bring you an immersive gaming experience
              like never before!
            </WorkGridItem>
          </Section>
          <Section delay={0.6}>
            <WorkGridItem id="aducion" title="Aducion" thumbnail={thumbAducion}>
              ...
              marketing and social media to promote properties, attract
              potential buyers or renters, and generate leads.
            </WorkGridItem>
          </Section>
        </SimpleGrid>
      </Container>
